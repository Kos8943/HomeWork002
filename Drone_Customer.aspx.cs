...
{
    public partial class Drone_Customer : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataTable dt = ConnectDB.ReadDroneCustomer();
        ...
        {
            Response.Redirect("Drone_Customer_Create.aspx");
        }
